...
object Usage:
  def apply(): Dom = Dom.raw("""<h2>WebJars work with most JVM-based containers and web frameworks.</h2>
...
object PlayFramework:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Play 2.6 (<a href="https://github.com/webjars/sample-play2" target="_blank" rel="noopener noreferrer">Sample Source</a>)</h2>
...
object Xitrum:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Xitrum</h2>
...
object Servlet3:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Servlet 3</h2>
...
object Servlet2:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Servlet 2</h2>
...
object Jsf:
  def apply(): Dom = Dom.raw("""<h2>Instructions for JSF</h2>
...
object Grails:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Grails (<a href="https://github.com/webjars/sample-grails" target="_blank" rel="noopener noreferrer">example app</a>)</h2>
...
object Dropwizard:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Dropwizard (<a href="https://github.com/webjars/sample-dropwizard" target="_blank" rel="noopener noreferrer">example app</a>)</h2>
...
object SpringBoot:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Spring Boot (<a href="https://github.com/webjars/sample-spring_boot" target="_blank" rel="noopener noreferrer">example app</a>)</h2>
...
object SpringMvc:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Spring MVC</h2>
...
object Tapestry:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Apache Tapestry (<a href="https://github.com/webjars/sample-tapestry" target="_blank" rel="noopener noreferrer">example app</a>)</h2>
...
object Wicket:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Apache Wicket (<a href="https://github.com/webjars/sample-wicket" target="_blank" rel="noopener noreferrer">example app</a>)</h2>
...
object Pippo:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Pippo</h2>
...
object Ring:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Ring (<a href="https://github.com/webjars/sample-clojure" target="_blank" rel="noopener noreferrer">example app</a>)</h2>

<p>Ring makes it easy to expose WebJars through the <code>wrap-resource</code> function.</p>""")

object Dandelion:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Dandelion</h2>
...
object Vertx:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Vert.x Web</h2>
...
object Quarkus:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Quarkus</h2>
...
object Ktor:
  def apply(): Dom = Dom.raw("""<h2>Instructions for Ktor (<a href="https://github.com/webjars/sample-ktor" target="_blank" rel="noopener noreferrer">Sample Source</a>)</h2>
