            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-column align-items-center justify-content-center gap-3 mb-3">
                    <div class="search-input">
                        ...
                        <svg id="clearSearch" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16" role="button" aria-label="Clear search" tabindex="0">
                ...
                <!-- List title — updated client-side to reflect popular vs. search results -->
                <div class="d-flex align-items-center justify-content-between mt-3 mb-2">
                    <h2 id="listTitle" class="h5 fw-bold mb-0">Popular WebJars</h2>
                </div>
