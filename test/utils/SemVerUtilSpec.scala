...
class SemVerUtilSpec extends Specification {
  ...
  "SemVerUtil.convertSemVerToMaven" should {
    ...
    "work with range sets" in {
      ...
      SemVerUtil.convertSemVerToMaven(">=1.2.16 1.4.x")      must be equalTo Some("[1.2.16,1.5)")
      SemVerUtil.convertSemVerToMaven(">=1.2.16 1.4.0")      must be equalTo Some("[1.2.16,1.4.0]")
    }
    "work with hyphen ranges" in {
      SemVerUtil.convertSemVerToMaven("1 - 2")           must be equalTo Some("[1,3)")
      SemVerUtil.convertSemVerToMaven("1 - 2.4")         must be equalTo Some("[1,2.5)")
      ...
      SemVerUtil.convertSemVerToMaven("1.2 - 2")           must be equalTo Some("[1.2,3)")
      SemVerUtil.convertSemVerToMaven("1.2 - 1.4")         must be equalTo Some("[1.2,1.5)")
      ...
      SemVerUtil.convertSemVerToMaven("1.2.3 - 2")           must be equalTo Some("[1.2.3,3)")
      SemVerUtil.convertSemVerToMaven("1.2.3 - 1.4")         must be equalTo Some("[1.2.3,1.5)")
      ...
      SemVerUtil.convertSemVerToMaven("1.2.3-alpha - 2")           must be equalTo Some("[1.2.3-alpha,3)")
      SemVerUtil.convertSemVerToMaven("1.2.3-dev-r - 2")           must be equalTo Some("[1.2.3-dev-r,3)")
      SemVerUtil.convertSemVerToMaven("1.2.3-alpha - 1.4")         must be equalTo Some("[1.2.3-alpha,1.5)")
      SemVerUtil.convertSemVerToMaven("1.2.3-dev-r - 1.4")         must be equalTo Some("[1.2.3-dev-r,1.5)")
