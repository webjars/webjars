...
class SemVerSpec extends PlaySpecification with GlobalApplication {
  ...
  "toMaven" should {
    "work" in {
      ...
      SemVer.toMaven(">=1.2.3 <2.0.0-0||2.1.0") must beASuccessfulTry("[1.2.3,2.0.0-0),[2.1.0]")
      SemVer.toMaven(">=1.2.3 <2.0.0-0||>=2.1.0 <3.0.0-0") must beASuccessfulTry("[1.2.3,2.0.0-0),[2.1.0,3.0.0-0)")
    }
  }
